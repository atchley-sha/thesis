...
As in the baseline scenario, the updated transit skims output from the WFRC model's network assignment in this model scenario are taken directly as inputs to ActivitySim.
