...
targets::tar_read(combined_tr_mode_split_table) %>%
	...
	footnote(number = "\"Transit\" here refers to the Transit scenario, not the mode of travel")
```
...
#| fig-cap: Geographic distribution of the change in trips (WFRC model).
...
#| fig-cap: Geographic distribution of the change in trips (ActivitySim).
#| fig-env: sidewaysfigure
#| fig-width: 9
#| fig-height: 6
