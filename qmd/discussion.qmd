...
Each scenario had a total runtime of 16–17 hours on this hardware, but removing the assignment steps and all but one trip distribution feedback loop -- as in, a single run of the demand model --- reduces the run time to approximately 10 hours.
...
x <- targets::tar_read(time_spent_table) |>
