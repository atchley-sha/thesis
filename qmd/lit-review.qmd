...
Figures [-@fig-network-aggregate] and [-@fig-network-synth] show an example of the trips distributed across several TAZs in the various model types.
...
![Trip-based microsimulation](./../images/trip.png){#fig-network-synth-1} ![Activity (tour)-based](./../images/tour.png){#fig-network-synth-2}
