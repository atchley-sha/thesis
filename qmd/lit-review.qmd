...
![Trip-based](../output/example_flowchart_comparison/aggregate.png){#fig-pipeline-example-1}

![Activity-based](../output/example_flowchart_comparison/synthetic.png){#fig-pipeline-example-2}
