...
Though many studies have shown that trip production and mode choice behavior differ by ethnic group even after controlling for income [@cite], including such variables in trip-based models is problematic.
