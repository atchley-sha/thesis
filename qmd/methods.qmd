...
This model takes similar socioeconomic data along with data mapping the levels of urbanization in each TAZ to predict vehicle availability.
I then assigns the number of vehicles for each combination of household size, number of workers, and income group.
