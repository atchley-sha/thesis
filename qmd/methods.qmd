...
The representative trip-based model is the 2019 Wasatch Front travel demand model, and is the current production model used by the Wasatch Front Regional Council (WFRC).
This model covers much of the Salt Lake City-Provo-Ogden, Utah Combined Statistical Area.
