...
Change in travel behavior could arise in response to changes in land use, transportaiton infrastructure, and social/economic factors, and so we create three hypothetical model scenarios that each implement one of these aspects.
