...
This target work-from-home percentage is set at `r targets::tar_read(wfrc_hbj_base_pct)`, based on a weighted average from the WFRC model data.
...
<!-- Each scenario intends to be representative of a real-world  -->\
