...
targets::tar_read(time_spent_table) %>% 
	...
	footnote(
		number = c(
			...
			"These analyses use the \"common\" structure directly and so took identical time and hese analyses use the \"common\" structure directly and so took identical time and
effort between the two models"
		)
	)
