# Scenario 3: Increase in Remote Work {#3_wfh-sec-wfh}
...
## Considerations for Modelling Remote Work {#3_wfh-sec-remote-work-considerations}
...
Additionally, for home-based other trips, ActivitySim predicts a greater increase in the number of trips than in person-miles, which shows that ActivitySim is at least implicitly modeling the effects found by @moreno_microscopic_2017 and @moeckel_working_2017, where longer work trips are being exchanged for shorter discretionary trips.
