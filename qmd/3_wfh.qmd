...
@moreno_microscopic_2017 similarly propose the existence of a "travel time budget", where a decrease in trips of one purpose will increase the time people allocate for trips of another purpose and vice versa.
...
targets::tar_read(combined_wfh_mode_split_diff) |>
	...
	align(j = 3:9, align = "center", part = "a") |>
	merge_v(j = 1) |>
	hline(i = c(4,8)) |>
	fix_border_issues() |>
	set_table_properties(layout = "fixed") |>
