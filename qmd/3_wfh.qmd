...
This figure shows the difference in trip length frequency distribution for Home-based Work trips between the Remote Work scenario and the baseline scenario.
...
The distribution for ActivitySim shows a general shift toward shorter trips with increased remote work, though this is not universally true.
