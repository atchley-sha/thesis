...
The second is that all pairs of zones that saw an increase in non--home-based trips include an origin or destination in the new development, i.e. the home zones of the new population.
...
@fig-lu-desire-abm shows desire lines of all trips made by individuals living in the new development zones.
