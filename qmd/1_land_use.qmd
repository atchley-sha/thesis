# Scenario 1: Change in Land Use {#1_land_use-1_land_use-1_land_use-1_land_use-sec-landuse}
...
Changing the land use as we did in @tbl-the-point-data has two effects in the WFRC model: the increase in population changed the total quantity of non--home-based trips, and the increase in employment changed the distribution of non--home-based trips.
Because the change in employment was much more significant than the change in population, many more non--home-based trip ends were attracted to the development zones compared to the relatively little global increase in non--home-based trips due to the population.
