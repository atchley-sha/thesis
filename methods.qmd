...
This section compares the output of PopulationSim to the \acr{WFRC} model on several of these variables ***list them***.
...
The areas near Herriman and Eagle Mountain aren't great, but others are pretty good.
