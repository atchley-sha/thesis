...
Because of this, there are few direct comparisons of model outputs.
...
While this research does not directly compare the outputs of ActivitySim to those of the \acr{WFRC} model, it remains crucial to ensure consistent performance between the two models for meaningful analyses.
...
@fig-landuse-site-imagery shows imagery of the site.
...
The results (Sections [-@sec-landuse]--[-@sec-wfh]) describe the process of coding each scenario and analyzing them, as well as the analyses themselves.
