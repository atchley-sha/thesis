...
***Transition to ActivitySim outputs.***
...
The default ActivitySim configuration is based on San Francisco, and so coefficients on variables such as travel time will be optimized for that area (hence why there are so many more transit trips).
