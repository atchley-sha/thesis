...
Activity-based models (ABMs) have been championed by researchers and many practitioners as being theoretically superior to the trip-based models historically used in transportation planning efforts since the 1950's.
...
We do this by applying an array of infrastructure and behavior scenarios to both an ABM and a trip-based model representing the Wasatch Front (Salt Lake City) region of Utah, USA.
The results will compare the implications of each model and help inform agencies that are considering adopting an ABM. 
