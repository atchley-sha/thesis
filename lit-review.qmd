...
For something like an equity analysis, for example, it is impossible to determine the "winners" and "losers" of a potential policy without using race/gender/etc. as variables in the trip generation and destination and model choice steps [@bills_looking_2017].
...
However, (they, @cite) note, the hope is that over an area the inconsistencies would "cancel out", leaving an overall accurate forecast.
...
ABMs take more time, more computing power, and more money to run.
