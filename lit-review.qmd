...
@fig-network-example shows an example comparison of network assignment in the various types of models. @fig-network-tbm shows a TBM.... visual representation of an individual's travel in a typical trip-based model.... Though each individual's trips are known, in a trip-based model there is no sense of consistency between trips. The activity-based approach adds this consistency by modeling tours, and only generating trips consistent with each tour.

::: {#fig-network-example layout="[[-25,50,-25], [50,50]]"}
