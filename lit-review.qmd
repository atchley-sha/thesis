...
Rather than using aggregate data, \acr{ABM}s use data representing actual or synthetic population, with individual person and household data [@vovsha_activity-based_2005].
...
Example travel pattern for an individual in both a trip-based microsimulation model and an \acr{ABM}.
:::
