...
There is also not a consensus that activity-based models result in better infrastructure forecasts, the primary---or even sole---purpose of many regions' travel demand analysis efforts [@shan2012; @ferdous_comparison_2012].
The difficult reputation of activity-based models --- in many cases fairly earned --- has led many regions to delay the adoption of an activity-based travel model, and instead adapt their trip-based models to analyze the complex policies (e.g. pricing, teleworking, etc.) that activity-based models were designed explicitly to enable.

At the same time, the software with which to conduct activity-based travel modeling has greatly improved from those first implementations.
